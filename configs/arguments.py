...
def get_common_args():
    ...
    parser.add_argument(
        "--project", type="str", default="StarCraft-II", help="The project which env is in"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--logger", type=str, default="wandb", help="the logger for the experiment"
    )
    parser.add_argument(
        "--load_model",
        type=bool,
    ...
    parser.add_argument(
        "--stats", type=str, default="", help="the stats file for data normalization"
    )
    parser.add_argument(
        "--delta_time", type=float, default=1, help="delta time per step"
    )
    parser.add_argument(
        "--step_mul", type=int, default=8, help="how many steps to make an action"
    )
    parser.add_argument(
