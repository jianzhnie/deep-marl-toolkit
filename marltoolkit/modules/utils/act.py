...
from marltoolkit.utils.distributions import (CustomBernoulli,
                                             CustomCategorical, DiagGaussian)
...
class ACTLayer(nn.Module):
    ...
    def __init__(self, action_space, inputs_dim, use_orthogonal, gain):
        ...
        if action_space.__class__.__name__ == 'Discrete':
            ...
            self.action_out = CustomCategorical(inputs_dim, action_dim,
                                                use_orthogonal, gain)
            ...
            action_dim = action_space.shape[0]
            self.action_out = CustomBernoulli(inputs_dim, action_dim,
                                              use_orthogonal, gain)
            ...
            for action_dim in action_dims:
                self.action_outs.append(
                    CustomCategorical(inputs_dim, action_dim, use_orthogonal,
                                      gain))
            ...
            self.action_outs = nn.ModuleList([
                ...
                CustomCategorical(inputs_dim, discrete_dim, use_orthogonal,
                                  gain),
            ])
